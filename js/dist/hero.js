...
/***/ "./web/app/themes/cheleyCamps/acf-blocks/hero/js/controller.js":
/*!*********************************************************************!*\
  !*** ./web/app/themes/cheleyCamps/acf-blocks/hero/js/controller.js ***!
  \*********************************************************************/
...
/* harmony export */ });
/* harmony import */ var _js_src_utils_inpagenav__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../js/src/__utils/inpagenav */ "./web/app/themes/cheleyCamps/js/src/__utils/inpagenav.js");


// GLOBAL APP CONTROLLER
const controller = {
	init() {
		_js_src_utils_inpagenav__WEBPACK_IMPORTED_MODULE_0__["default"].init();
	},
	loaded() {},
	resized() {},
	scrolled() {
		_js_src_utils_inpagenav__WEBPACK_IMPORTED_MODULE_0__["default"].scrollSpy();
	},
	keyDown() {},
	mouseUp() {},
};
...
/***/ "./web/app/themes/cheleyCamps/js/src/__utils/customFunctions.js":
/*!**********************************************************************!*\
  !*** ./web/app/themes/cheleyCamps/js/src/__utils/customFunctions.js ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./web/app/themes/cheleyCamps/js/src/__utils/inpagenav.js":
/*!****************************************************************!*\
  !*** ./web/app/themes/cheleyCamps/js/src/__utils/inpagenav.js ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _customFunctions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./customFunctions */ "./web/app/themes/cheleyCamps/js/src/__utils/customFunctions.js");
    ...
    scrollSpy() {
        if (this.subnav) {
            ...
            [...scrollHooks].forEach((hook, index) => {
                const elemOffset = (0,_customFunctions__WEBPACK_IMPORTED_MODULE_0__.offsetFunction)(hook).top - this.subnav.offsetHeight - this.header.offsetHeight - 3;
                if (scrollPosition >= elemOffset) {
                    lastHook = hook;
                }
            });

            if (scrollPosition < (0,_customFunctions__WEBPACK_IMPORTED_MODULE_0__.offsetFunction)(firstHook).top) {
            ...
            if (lastHook !== null) {
                ...
                if (!navElementParent.classList.contains('active')) {
                    const navElementSiblings = (0,_customFunctions__WEBPACK_IMPORTED_MODULE_0__.getSiblings)(navElementParent);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new InpageNav());
...
"use strict";
/*!*****************************************************************!*\
  !*** ./web/app/themes/cheleyCamps/acf-blocks/hero/js/script.js ***!
  \*****************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _controller__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./controller */ "./web/app/themes/cheleyCamps/acf-blocks/hero/js/controller.js");
