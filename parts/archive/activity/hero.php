<?php
/**
 * Activity archive custom post type hero.
 *
 * @package    WordPress
...
$heading           = get_field( 'aa_heading', 'options' ) ? get_field( 'aa_heading', 'options' ) : $archive_post_type->labels->name;
$background_image  = get_field( 'aa_background_image', 'options' );
$description       = get_field( 'aa_description', 'options' );
